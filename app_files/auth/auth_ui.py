...
def _render_login_form() -> None:
    ...
    st.caption("Sign in to continue your diligence workspace.")
...
def _render_signup_form() -> None:
    ...
    st.caption("Use this to save progress, return later, and prepare for account-based persistence.")
    with st.form("auth_signup_form"):
        ...
        confirm_password = st.text_input(
            ...
            key="auth_signup_confirm_password",
        )
...
def render_auth_screen() -> None:
    ...
    with left:
            ...
            ">
                <div>
                    ...
                    <p style="max-width:780px; margin:0; color:#E2E8F0; line-height:1.65; font-size:1.02rem;">
                        Sign in to save your work, resume assessments, and keep franchise diligence organized as the platform moves toward cloud persistence.
                    </p>
                </div>
        ...
        with c3:
            _render_auth_value_card("Prepare for cloud", "Authenticated user IDs are ready for the next persistence phase.")
